...
HD_PWD='C:/Verilog_lab/pr2_fa/pr2_fa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pr2_fa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pr2_fa.tcl -notrace
