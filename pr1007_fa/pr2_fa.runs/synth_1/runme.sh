...
HD_PWD='C:/Verilog_lab/pr2_fa/pr2_fa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pr2_fa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pr2_fa.tcl
