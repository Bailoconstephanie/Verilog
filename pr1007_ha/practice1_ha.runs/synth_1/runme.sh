...
HD_PWD='C:/Verilog_lab/practice1_ha/practice1_ha.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice1_ha.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice1_ha.tcl
