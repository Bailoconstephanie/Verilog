...
HD_PWD='C:/Verilog_lab/practice1_ha/practice1_ha.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practice1_ha.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practice1_ha.tcl -notrace
